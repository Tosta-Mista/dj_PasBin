...
class FormIndex(View):
    ...
    template_name = 'dj_PasBin/create.html'
    payload = {'form': 'form'}
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render_to_response('dj_PasBin/create.html', self.payload, RequestContext(request))
...
class PasteDetails(View):
    def get(self, request, id):
        ...
        payload = {'paste': paste}
        return render_to_response('dj_PasBin/details.html', payload, RequestContext(request))
